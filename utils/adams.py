...
"""
Source : https://github.com/zeke-xie/stable-weight-decay-regularization

Paper : "Stable Weight Decay Regularization"
https://openreview.net/forum?id=YzgAOeA67xX

V2 : On the Overlooked Pitfalls of Weight Decay and How to Mitigate Them: A Gradient-Norm Perspective
https://openreview.net/pdf?id=vnGcubtzR1
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                denominator = exp_avg_sq_hat.sqrt().add(group["eps"])
